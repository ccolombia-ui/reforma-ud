...
id: m09
number: 9
title: "DS Presupuesto NICSP"
description: "Presupuesto público IES bajo NICSP — Resolución 533/2015 CGN."
crispPhase: modeling
rutaClark: [R1]
status: green
tags: [m09, reforma-udfjc, crisp-modeling, nicsp, presupuesto]
relations:
  pre: []
  pos: []
  co: []
  custom:
    glosario: ["con-ccp-clasificacion-presupuestal", "con-nicsp", "con-ccr-capacity-cost-rate", "con-bsc-s", "con-spadies"]
---
...
> **Licencia**: CC BY-SA 4.0 · **Cita sugerida**: Madera Sepúlveda, C. C. (2026). §09 · DS-Presupuesto: Estructura NICSP + CCP/SUE de UDFJC. *Reforma Vinculante UDFJC: Análisis, Buenas Prácticas y Prospectiva Transformativa* (cap-MI12, Sección 9). Universidad Distrital Francisco José de Caldas. https://reforma-ud.vercel.app/canonico/m09/ [DOI pendiente]

> [!abstract] §0 · Abstract
> Esta sección documenta el **marco presupuestal y contable de la UDFJC**, verificado contra 53 PDFs de resoluciones CSU 2014-2026, 12 resoluciones salariales y 3 estados financieros Q4-2025. Cobertura: jerarquía normativa (Constitución → Ley 30 → D.111 → [[con-ccp-clasificacion-presupuestal|CCP]] → Res CSU), estructura presupuestal UDFJC 2026 (3 fondos, 8 niveles CCP, $548.568M COP), 18 políticas contables [[con-nicsp-marco-estado-resultados|NICSP]] aplicables, cálculo [[con-ccr-capacity-cost-rate|CCR]] (Capacity Cost Rate) de un recurso docente con datos reales. Tres usos del modelo: (1) calibración TDABC (§10); (2) escenarios financieros S0-S5 (§08); (3) alimentación P4 [[con-bsc-s|BSC-s]].
...
§09 alimenta §10 (TDABC) con CCR base, §08 P4 (capacidades financieras) con tabla SMMLV-país, §11 (datasets MEN [[con-spadies-snies-dataset-men|SPADIES]] presupuesto-deserción).
...
*CC BY-SA 4.0 · Carlos Camilo Madera Sepúlveda · UDFJC · 2026-04-25 · sec-MI12-09 v1.2.0*
