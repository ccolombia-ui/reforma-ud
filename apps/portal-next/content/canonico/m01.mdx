...
relations:
  ...
  co: []
  custom:
    glosario: ["glo-crisp-dm", "glo-frame-3", "glo-acu-004-25", "glo-frame-1", "glo-frame-2", "glo-conpes-4069", "glo-autonomia-positiva", "glo-conpes-3934", "glo-piiom", "glo-caba", "glo-bsc-s", "glo-rbm-gac", "glo-cadena-normativa-multinivel", "glo-jtbd-christensen", "glo-odi-ulwick"]
---
...
> **Licencia**: CC BY-SA 4.0 · **Cita sugerida**: Madera Sepúlveda, C. C. (2026). §01 · Mandato Normativo. *Capítulo MI-12: Hoja de Ruta [[glo-crisp-dm|CRISP-DM]] para la Reforma Vinculante UDFJC* (cap-MI12, Sección 1). Universidad Distrital Francisco José de Caldas. [DOI pendiente]
...
La Magna Charta Universitatum (MCU) fue suscrita en Bolonia en 1988 por 388 universidades y ampliada en 2020 con más de 950 signatarias. La revisión de 2020 es conceptualmente crítica para esta sección porque introduce el concepto de **autonomía positiva**:
...
|:-:|--------|------|-------|-----------|
| 1 | Constitución Política de Colombia, Art. 69 | Norma | Constitucional | Colombia [-@colombia1991constitucion] |
| 2 | Ley 30 de 1992, Art. 6 | Ley | Legal | Colombia [-@colombia1992ley30] |
| 3 | CONPES 4069/2021 | Política pública | Nacional | CONPES [-@conpes2021cti] |
...
| 6 | Acuerdo CSU 04/2025 | Norma institucional | Institucional | UDFJC [-@udfjc2025acu00425] |
| 7 | Magna Charta Universitatum 2020 | Declaración internacional | Internacional | MCU Observatory [-@mcu2020] |
| 8 | Schot & Steinmueller (2018) | Artículo académico | Teórico | *Research Policy* 47(9) [@schot2018frame3] |
| 9 | UNESCO (2021) | Reporte global | Internacional | UNESCO Publishing [@unesco2021reimagining] |
...
*Fig-MI12-01 — Diagrama maestro de la cadena normativa multinivel: de MCU 2020 y [[glo-frame-3|Frame 3]] al [[glo-acu-004-25|Acuerdo CSU 04/2025]] vía Constitución 1991, Ley 30/1992, [[glo-conpes-4069|CONPES 4069/2021]], [[glo-conpes-3934|CONPES 3934/2018]] y [[glo-piiom|PIIOM 2022-2026]].*
...
El CONPES 4069 es el instrumento de política pública nacional que operacionaliza el mandato constitucional y legal de CTI para el decenio 2022-2031. Sus tres aportes fundamentales al mandato de la UDFJC son:

> [!success] §4.4 · Tres aportes del CONPES 4069 al mandato UDFJC
> 1. **Adopta Frame 3** de Schot & Steinmueller [-@schot2018frame3] como paradigma rector: la CTI no solo debe producir conocimiento (Frame 1) ni conectar actores (Frame 2), sino **dirigirse hacia transformaciones sociotécnicas** que resuelvan los desafíos nacionales.
> 2. **Establece 5 misiones nacionales** que todo el SNCTI (incluyendo las IES) debe operacionalizar a través del PIIOM.
> 3. **Adopta el modelo de Quíntuple Hélice** [@carayannis2012quintuple] que incorpora universidad, industria, gobierno, sociedad civil *y medio ambiente* como actores co-creadores del ecosistema de innovación.
...
El Programa Indicativo de Investigación y Misiones (PIIOM) del MinCiencias es el instrumento que convierte el marco conceptual del CONPES 4069 en **mandatos operativos** para todo el SNCTI. Las 5 misiones son:
...
**Implicación para la UDFJC**: Cada proyecto de investigación, cada currículo, cada iniciativa de extensión debe poder trazarse a al menos una de estas 5 misiones. Si no puede trazarse, no cumple el mandato del PIIOM y, por extensión, viola el Art. 6 de la Ley 30/1992 [@colombia1992ley30].

### §4.7 Acuerdo CSU 04/2025 — Operacionalización institucional del mandato

El ACU-004-25 es el instrumento institucional que traduce toda la cadena anterior al ordenamiento interno de la UDFJC. Sus artículos clave para la reforma son:
...
> | **Art. 98** | Plan de implementación | 45 días (≈ 20 jun 2025) | ⚠️ EXPIRADO |
...
> | **Art. 100** | Comisión de Implementación | Conformación pendiente | 🔴 No conformada |
> | **Art. 107** | Potestad rectoral discrecional | Primeros 2 años (2025-2027) | 🟢 Vigente |
...
El glosario consolidado del capítulo cap-MI12 establece definiciones unívocas para los términos más utilizados —y más malentendidos— en el debate de la reforma. Cada entrada se transcluye desde `60-glosario/`:
...
La diferencia entre la UDFJC anterior (Acuerdo CSU 03 de 1997) y la proyectada (ACU-004-25) no es cosmética — es una **re-ontologización** de la estructura organizativa:
...
El análisis del autor sobre la implementación del mandato normativo identifica seis riesgos sistémicos. Se etiquetan **RT1-RT6** (Riesgos de Transición) para evitar colisión con las retroalimentaciones R1-R6 del ciclo virtuoso institucional y con las cinco vías R-1 a R-5 de Clark [@clark1998entrepreneurial].
...
> [!note] §6 · Conceptos Clave de §01 (transcluidos del glosario consolidado del capítulo)
>
...
> - **Autonomía funcional e instrumental**: la autonomía universitaria del Art. 69 CO como capacidad para ejercer soberanía del conocimiento al servicio del territorio — no como derecho defensivo frente a políticas públicas.
> - **Deber normativo** (vs opción): el Art. 6 de la Ley 30/1992 convierte la "solución de necesidades nacionales" en deber legal, no en aspiración.
> - **Frame 3**: paradigma de política CTI que exige *direccionalidad* hacia transformaciones sociotécnicas [@schot2018frame3]; adoptado por CONPES 4069/2021.
> - **PIIOM 5 misiones**: Bioeconomía, Alimentaria, Energética, Sanitaria, Equitativa — mandatos operativos del SNCTI para 2022-2026.
> - **Re-ontologización**: cambio de la lógica organizativa de la UDFJC: de departamentos-silo a Escuelas-Instituto-Centros integrados por CABAs transversales.
...
*CC BY-SA 4.0 · Carlos Camilo Madera Sepúlveda · UDFJC · 2026-04-25 · sec-MI12-01 v1.0.0*
