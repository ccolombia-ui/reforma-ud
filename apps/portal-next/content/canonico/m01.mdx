...
> 1. Mapear la cadena normativa completa CO + UDFJC desde la MCU 2020 y [[glo-frame-3|Frame 3]] hasta el [[glo-acu-004-25|Acuerdo CSU 04/2025]].
...
> | **[[glo-frame-2|Frame 2]]**: Sistemas de Innovación | 1980s-2010s | ¿Cómo conectar actores? | Redes, clústeres, triple hélice | El crecimiento económico como fin; no cuestiona la dirección |
> | **[[glo-frame-3|Frame 3]]**: Cambio Transformativo | 2010s→ | ¿*Hacia dónde* dirigir la innovación? | **Direccionalidad** → misiones transformativas | Requiere repensar el propósito institucional |
>
> Fuente: Schot & Steinmueller [-@schot2018frame3].

**[[glo-frame-3|Frame 3]] es el marco del [[glo-acu-004-25|Acuerdo CSU 04/2025]]**. El [[glo-conpes-4069|CONPES 4069/2021]] lo adopta explícitamente como paradigma rector de la Política Nacional CTI. La universidad no solo debe producir conocimiento (Frame 1) ni solo conectarse a ecosistemas (Frame 2): debe asumir **direccionalidad** hacia transformaciones sociotécnicas que aborden desafíos de pobreza, injusticia, insostenibilidad y desigualdad [@schot2018frame3, p. 1555].
...
La [[glo-mcu-2020|Magna Charta Universitatum (MCU)]] fue suscrita en Bolonia en 1988 por 388 universidades y ampliada en 2020 con más de 950 signatarias. La revisión de 2020 es conceptualmente crítica para esta sección porque introduce el concepto de **[[glo-autonomia-positiva|autonomía positiva]]**:

> [!quote] §2.2 · MCU 2020 — [[glo-autonomia-positiva|Autonomía positiva]]
...
|:-:|--------|------|-------|-----------|
| 1 | [[glo-constitucion-1991-art-69\|Constitución Política de Colombia, Art. 69]] | Norma | Constitucional | Colombia [-@colombia1991constitucion] |
| 2 | [[glo-ley-30-1992-art-6\|Ley 30 de 1992, Art. 6]] | Ley | Legal | Colombia [-@colombia1992ley30] |
| 3 | [[glo-conpes-4069\|CONPES 4069/2021]] | Política pública | Nacional | CONPES [-@conpes2021cti] |
| 4 | [[glo-conpes-3934\|CONPES 3934/2018]] | Política pública | Nacional | CONPES [-@conpes2018crecverde] |
| 5 | [[glo-piiom\|PIIOM 2022-2026]] | Plan operativo | Nacional | MinCiencias [-@minciencias2022piiom] |
| 6 | [[glo-acu-004-25\|Acuerdo CSU 04/2025]] | Norma institucional | Institucional | UDFJC [-@udfjc2025acu00425] |
| 7 | [[glo-mcu-2020\|Magna Charta Universitatum 2020]] | Declaración internacional | Internacional | MCU Observatory [-@mcu2020] |
| 8 | [[glo-frame-3\|Schot & Steinmueller (2018) Frame 3]] | Artículo académico | Teórico | *Research Policy* 47(9) [@schot2018frame3] |
| 9 | [[glo-unesco-reimagining-2021\|UNESCO (2021)]] | Reporte global | Internacional | UNESCO Publishing [@unesco2021reimagining] |
...
El [[glo-conpes-4069|CONPES 4069]] es el instrumento de política pública nacional que operacionaliza el mandato constitucional y legal de CTI para el decenio 2022-2031. Sus tres aportes fundamentales al mandato de la UDFJC son:

> [!success] §4.4 · Tres aportes del CONPES 4069 al mandato UDFJC
> 1. **Adopta [[glo-frame-3|Frame 3]]** de Schot & Steinmueller [-@schot2018frame3] como paradigma rector: la CTI no solo debe producir conocimiento ([[glo-frame-1|Frame 1]]) ni conectar actores ([[glo-frame-2|Frame 2]]), sino **dirigirse hacia transformaciones sociotécnicas** que resuelvan los desafíos nacionales.
> 2. **Establece [[glo-cinco-misiones-piiom|5 misiones nacionales]]** que todo el [[glo-sncti|SNCTI]] (incluyendo las IES) debe operacionalizar a través del [[glo-piiom|PIIOM]].
> 3. **Adopta el modelo de [[glo-quintuple-helix|Quíntuple Hélice]]** [@carayannis2012quintuple] que incorpora universidad, industria, gobierno, sociedad civil *y medio ambiente* como actores co-creadores del ecosistema de innovación.
...
El [[glo-piiom|Programa Indicativo de Investigación y Orientación de Misiones (PIIOM)]] del MinCiencias es el instrumento que convierte el marco conceptual del [[glo-conpes-4069|CONPES 4069]] en **mandatos operativos** para todo el [[glo-sncti|SNCTI]]. Las [[glo-cinco-misiones-piiom|5 misiones]] son:
...
**Implicación para la UDFJC**: Cada proyecto de investigación, cada currículo, cada iniciativa de extensión debe poder trazarse a al menos una de estas 5 misiones. Si no puede trazarse, no cumple el mandato del PIIOM y, por extensión, viola el [[glo-ley-30-1992-art-6|Art. 6 de la Ley 30/1992]] [@colombia1992ley30].

### §4.7 Acuerdo CSU 04/2025 — Operacionalización institucional del mandato

El [[glo-acu-004-25|ACU-004-25]] es el instrumento institucional que traduce toda la cadena anterior al ordenamiento interno de la UDFJC. Sus artículos clave para la reforma son:
...
> | **Art. 98** | [[glo-plan-implementacion\|Plan de implementación]] | 45 días (≈ 20 jun 2025) | ⚠️ EXPIRADO |
...
> | **Art. 100** | [[glo-comision-implementacion-art-100\|Comisión de Implementación]] | Conformación pendiente | 🔴 No conformada |
> | **Art. 107** | [[glo-potestad-rectoral-transitoria\|Potestad rectoral discrecional]] | Primeros 2 años (2025-2027) | 🟢 Vigente |
...
El glosario consolidado del capítulo cap-MI12 establece definiciones unívocas para los términos más utilizados —y más malentendidos— en el debate de la reforma. Cada entrada se transcluye desde el [Glosario Universal](../00-glosoario-universal/_README.md):

![[glo-cadena-normativa-multinivel]]

![[glo-autonomia-funcional-instrumental]]

![[glo-frame-3]]

![[glo-piiom]]

![[glo-cinco-misiones-piiom]]

![[glo-acu-004-25]]

![[glo-quintuple-helix]]

![[glo-iniciativas-i0-i4]]
...
La diferencia entre la UDFJC anterior (Acuerdo CSU 03 de 1997) y la proyectada ([[glo-acu-004-25|ACU-004-25]]) no es cosmética — es una **[[glo-re-ontologizacion|re-ontologización]]** de la estructura organizativa:
...
El análisis del autor sobre la implementación del mandato normativo identifica seis riesgos sistémicos. Se etiquetan **[[glo-riesgos-rt1-rt6|RT1-RT6]]** (Riesgos de Transición) para evitar colisión con las retroalimentaciones R1-R6 del ciclo virtuoso institucional y con las [[glo-cinco-vias-clark|cinco vías R-1 a R-5 de Clark]] [@clark1998entrepreneurial].
...
> | **RT5** Ausencia de sistema de seguimiento | ALTA | ALTO | Framework de gestión estratégica ([[glo-bsc-s\|BSC-s]] + [[glo-rbm-gac\|RBM-GAC]]) con dashboard de indicadores institucionales |
...
> [!note] §6 · Conceptos Clave de §01 (transcluidos del [Glosario Universal](../00-glosoario-universal/_README.md))
>
> - **[[glo-cadena-normativa-multinivel|Cadena normativa multinivel]]**: jerarquía de instrumentos normativos que van desde lo internacional (MCU 2020, Frame 3) hasta lo institucional (ACU-004-25), estableciendo una obligación acumulativa de alineación.
> - **[[glo-autonomia-funcional-instrumental|Autonomía funcional e instrumental]]**: la autonomía universitaria del Art. 69 CO como capacidad para ejercer soberanía del conocimiento al servicio del territorio — no como derecho defensivo frente a políticas públicas.
> - **[[glo-deber-normativo|Deber normativo]]** (vs opción): el [[glo-ley-30-1992-art-6|Art. 6 de la Ley 30/1992]] convierte la "solución de necesidades nacionales" en deber legal, no en aspiración.
> - **[[glo-frame-3|Frame 3]]**: paradigma de política CTI que exige *direccionalidad* hacia transformaciones sociotécnicas [@schot2018frame3]; adoptado por [[glo-conpes-4069|CONPES 4069/2021]].
> - **[[glo-cinco-misiones-piiom|PIIOM 5 misiones]]**: Bioeconomía, Alimentaria, Energética, Sanitaria, Equitativa — mandatos operativos del [[glo-sncti|SNCTI]] para 2022-2026.
> - **[[glo-re-ontologizacion|Re-ontologización]]**: cambio de la lógica organizativa de la UDFJC: de departamentos-silo a [[glo-escuela|Escuelas]]-[[glo-instituto|Instituto]]-[[glo-centro|Centros]] integrados por [[glo-caba|CABAs]] transversales.
...
> 3. **La re-ontologización §4.10** define la estructura organizativa objetivo: Escuelas, Institutos, Centros con CABAs transversales. Esta es la arquitectura sobre la cual deberán operar los instrumentos de gestión estratégica (BSC-s, RBM-GAC), de minería de datos (CRISP-DM) y de participación comunitaria ([[glo-jtbd-christensen|JTBD]]/[[glo-odi-ulwick|ODI]]).
