...
relations:
  ...
  co: []
  custom:
    glosario: ["con-bsc-s", "con-rbm-gac", "con-crisp-dm", "con-odi-ulwick", "con-ccr-capacity-cost-rate", "con-jtbd-christensen", "con-cca", "con-nicsp", "con-caba", "con-snies"]
---
...
> **Licencia**: CC BY-SA 4.0 · **Cita sugerida**: Madera Sepúlveda, C. C. (2026). §08 · Framework BSC-s × RBM-GAC × CRISP-DM. *Reforma Vinculante UDFJC: Análisis, Buenas Prácticas y Prospectiva Transformativa* (cap-MI12, Sección 8). Universidad Distrital Francisco José de Caldas. https://reforma-ud.vercel.app/canonico/m08/ [DOI pendiente]
> **Versión 2.0.0**: Esta sección recarga e integra el contenido del documento interno APE-000 (`1-research/BPA-010-escuelas-ciencias-basicas/2--wbk-analisis-prospectivo-escenarios/WBK-APE-000-business-understanding.md`) con cuatro refinamientos quirúrgicos: (a) integración de outcome statements [[con-odi-ulwick|ODI]] (de §04) en P2; (b) matriz 21 BPAs × 5 unidades × niveles L0-L4 en P3; (c) mapping vías Clark R-1..R-5 × CAPEX/OPEX con tabla SMMLV-país-2026 en P4; (d) citaciones APA externalizadas (no más wikilinks intra-corpus). El M08 v4.0.0 anterior (modelo metodológico abstracto) queda **descontinuado** — esta v2.0.0 es la versión publicable.
...
| 2. Data Understanding | JTBD comunidad · benchmarking 21 IES · créditos [[con-cca|CCA]] · datasets MEN | §04, §05, §06, §11 |
| 3. Data Preparation | 21 BPAs activadoras · presupuesto [[con-nicsp-marco-estado-resultados|NICSP]] · TDABC | §07, §09, §10 |
...
| **V3 × INT-DOC** | Asistir a Consejo de Escuela | *Maximizar el número de decisiones colegiadas en las que participo cuando se discute racionalización de oferta* | 🟡 medio: percepción carga adicional | Votar racionalización de oferta | Co-gobernar [[con-caba|CABA]] con estudiantes y administrativos |
...
| **QV-V4.ADM** | Ética | Administrativo | % datos [[con-snies-dataset-men|SNIES]]/SICIUD con auditoría calidad | [medir] | 30% | 50% | 80% | 90% | ≥95% |
...
| v2.0.0 | 2026-04-25 | RECARGA APE-000 + 4 refinamientos: ODI integrado P2; matriz 21 BPAs × unidades × L0-L4 P3; mapping Clark + SMMLV-país-2026 P4; citaciones APA externalizadas. M08 v4.0.0 anterior descontinuado. |
| **v2.1.0** | **2026-04-27** | **Refactor audit-driven M08**: integración con corpus canónico (116 conceptos `con-*.md`). (a) **Fase A · 3 conceptos creados**: `con-ccr-capacity-cost-rate` (TDABC), `con-framework-86-indicadores-s0-s5` (sistema integral), `con-iuca-ivc-ivo-indices` (3 índices ponderados). (b) **Fase C · refactor wikilinks**: 14 legacy `_archived/60-glosario/glo-X` → `../00-glosoario-universal/con-X` (incluye redirección `glo-cuadrante-pasteur` → `con-cuadrante-pasteur-stokes`). Cero wikilinks rotos en `tupla__relations[]`. |

---

*CC BY-SA 4.0 · Carlos Camilo Madera Sepúlveda · UDFJC · 2026-04-27 · sec-MI12-08 v2.1.0*
