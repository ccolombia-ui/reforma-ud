...
id: m12
number: 12
title: "Prospectiva por escenarios · 5 escenarios para deliberación comunitaria"
...
relations:
  ...
  co: []
  custom:
    glosario: ["glo-crisp-dm", "glo-acu-004-25", "glo-jtbd-christensen", "glo-cca", "glo-bsc-s", "glo-rbm-gac", "glo-nicsp", "glo-cadena-normativa-multinivel", "glo-caba", "glo-odi-ulwick", "glo-ccr-capacity-cost-rate"]
---
...
> **Posición**: cierre integrador del capítulo MI-12 — fases 5 (Evaluation) y 6 (Deployment) del [[glo-crisp-dm|CRISP-DM]] aplicadas a la Reforma Vinculante UDFJC bajo el [[glo-acu-004-25|Acuerdo CSU 04/2025]].
...
|---|---|---|---|
| **1. Business Understanding** | ¿Por qué transformar? | §01 mandato + §02 ciclo virtuoso + §03 estándares | [[glo-cadena-normativa-multinivel|Cadena normativa multinivel]] mandatoria + modelo ΩMT + parámetros de calidad |
...
| **2028** | S2 maduro | (13 BPAs L2) | Política CCA aprobada; primeros Paquetes CCA certificados; [[glo-caba|CABA]] Design Factory operativa | ~200 | — | 38 | CSU + Decanos |
...
- **JTBD comunidad**: 6 actores con jobs y outcomes [[glo-odi-ulwick|ODI]] (§04).
...
- **TDABC** con [[glo-ccr-capacity-cost-rate|CCR]] y 12 time equations (§10).
