...
description: "OECD Learning Compass 2030, UDL 3.0, ABET, CDIO Syllabus v3.0, ISO 21001:2018, TUNING-AL, ARCU-SUR + heatmap 9 Escuelas UDFJC."
crispPhase: business
rutaClark: [R1]
status: green
tags: [m03, estandares, oecd, udl, abet, cdio, iso-21001]
relations:
  pre: []
  pos: []
  co: []
  custom:
    glosario: ["con-cdio-syllabus", "con-iso-21001", "con-jtbd-christensen", "con-frame-3", "con-oecd-learning-compass-2030", "con-conpes-4069"]
---
...
> **Licencia**: CC BY-SA 4.0 · **Cita sugerida**: Madera Sepúlveda, C. C. (2026). §03 · Estándares Internacionales para la Calidad Educativa. *Reforma Vinculante UDFJC: Análisis, Buenas Prácticas y Prospectiva Transformativa* (cap-MI12, Sección 3). Universidad Distrital Francisco José de Caldas. https://reforma-ud.vercel.app/canonico/m03/ [DOI pendiente]
...
El [Cuadrante Pasteur](#cuadrante-pasteur) [@stokes1997pasteur] es el eje epistemológico transversal de la formación universitaria orientada a [[con-frame-3|Frame 3]]: investigación que busca entendimiento fundamental Y consideración de uso. Esta sección desarrolla cómo OECD Learning Compass [@oecd2018learningcompass] y MIT UROP operan como realizaciones empíricas del Cuadrante Pasteur a nivel curricular.
...
|---|---|---|
| **Aspiracional** | Define competencias futuras del egresado | [[con-oecd-learning-compass-2030|OECD Learning Compass 2030]], UDL 3.0 |
...
*Fig-MI12-20 — Matriz roles [[3-diseño-capitulo-libro/_archived/60-glosario/glo-jtbd-christensen|JTBD]] × estándares (M03)*
...
|---|---|---|
| OECD Learning Compass | [[con-conpes-4069|CONPES 4069/2021]] + PIIOM | Frame 3 común |
...
| v1.1.0 | 2026-04-25 | Status DRAFT → FINAL (S-CHAP-A peer-review pasado). |
| **v1.2.0** | **2026-04-27** | **Refactor audit-driven M03**: integración con corpus canónico Glosario Universal (99 conceptos `con-*.md` post-M03). (a) **Fase A1 · 6 must-have**: `con-oecd-learning-compass-2030`, `con-udl-3`, `con-abet-acreditacion`, `con-cdio-syllabus`, `con-iso-21001`, `con-tuning-america-latina`. (b) **Fase A2 · 5 secondary**: `con-mit-urop`, `con-eur-ace`, `con-arcu-sur`, `con-boyer-healey-research-teaching`, `con-cognia-deprecated`. (c) **Fase B · 5 enriquecimientos M00/M01/M02** con cross-refs M03 (cuadrante-pasteur-stokes, frame-3, decreto-1330-2019 + reparación wikilink bib, retroalimentaciones-r1-r6, acu-004-25). (d) **Fase C · refactor wikilinks**: 16 legacy `_archived/60-glosario/glo-X` → `../00-glosoario-universal/con-X`; transclusiones consolidadas migradas; redirección `glo-cuadrante-pasteur` → `con-cuadrante-pasteur-stokes` (canónico M02 sin duplicar). Cero wikilinks rotos. M03 plenamente integrado al corpus. |

---

*CC BY-SA 4.0 · Carlos Camilo Madera Sepúlveda · UDFJC · 2026-04-27 · sec-MI12-03 v1.2.0*
