...
relations:
  ...
  co: []
  custom:
    glosario: ["con-frame-3", "con-mlp-geels", "con-piiom", "con-frame-2", "con-frame-1", "con-caba", "con-bsc-s", "con-cca"]
---
...
> **Licencia**: CC BY-SA 4.0 · **Cita sugerida**: Madera Sepúlveda, C. C. (2026). §02 · Ciclo Virtuoso ΩMT. *Reforma Vinculante UDFJC: Análisis, Buenas Prácticas y Prospectiva Transformativa* (cap-MI12, Sección 2). Universidad Distrital Francisco José de Caldas. https://reforma-ud.vercel.app/canonico/m02/ [DOI pendiente]
...
>
> **Palabras clave**: innovación transformativa, meta-telos, ciclo virtuoso, retroalimentaciones misionales, universidades emprendedoras, Geels [[con-mlp-geels|MLP]], Frame 3, CABAs, tres vicerrectorías.
...
El ACU-004-25 operacionaliza el mandato normativo descrito en §01 de este capítulo. Su articulación con el CONPES 4069 [-@conpes2021cti] y el [[con-piiom|PIIOM 2022-2026]] [@minciencias2022piiom] requiere que la UDFJC adopte el Frame 3 de política de innovación —direccionalidad hacia misiones transformativas— y no se limite al [[con-frame-2|Frame 2]] (conexión de actores). Esta sección provee los fundamentos teóricos para esa transición.
...
*Fig-MI12-05 — [[3-diseño-capitulo-libro/_archived/60-glosario/glo-mlp-geels|MLP]] de Geels aplicado a UDFJC: Paisaje, Régimen dominante y Nichos transformativos*
...
*Fig-MI12-12 — Evolución [[3-diseño-capitulo-libro/_archived/60-glosario/glo-frame-1|Frame 1]] → [[3-diseño-capitulo-libro/_archived/60-glosario/glo-frame-2|Frame 2]] → [[3-diseño-capitulo-libro/_archived/60-glosario/glo-frame-3|Frame 3]] (Schot & Steinmueller, 2018): la pregunta pasa de "cuánto" a "hacia dónde"*
...
*Fig-MI12-07 — Espiral SECI de Nonaka & Takeuchi (1995) aplicada al ciclo virtuoso: la [[3-diseño-capitulo-libro/_archived/60-glosario/glo-caba|CABA]] como Ba institucional*
...
*Fig-MI12-15 — Red de CoPs convergiendo en la [[3-diseño-capitulo-libro/_archived/60-glosario/glo-caba|CABA]] como super-CoP transdisciplinaria y nodo vitalizador del ciclo virtuoso*
...
> Una escuela alcanza el estado S5 cuando sus CABAs tienen las **6 R en estado 🟢 Activa simultáneamente**. Si alguna R permanece en 🔴 Rota, el ciclo virtuoso está incompleto y el impacto misional (P1 [[con-bsc-s|BSC-s]]) está comprometido. No existe jerarquía entre las R: romper cualquiera degrada el sistema (cf. Eq-MI12-02).
...
| **R-5** | Cultura Emprendedora Integrada | Estudiantes construyen portafolio [[con-cca|CCA]]; investigar es lo normal; servir al territorio es identidad colectiva | 🎓 Estudiante Soberano + todos los roles |

### §4.6 La CABA como Nodo Vitalizador

La **Comunidad Académica de Base ([[con-caba|CABA]])** es el dispositivo operativo que hace posible el salto cuántico Sub-N1 → N4:
...
![[con-procesos-misionales-pm1-pm2-pm3]]
...
![[con-anti-patron-departamentalizacion]]
...
|---|---|---|
| 1.0.0 | 2026-04-25 | Atomización inicial desde M02-ciclo-virtuoso-v3.1.0. Migración a cap-MI12 con transclusiones a figuras, ecuaciones, estrategias, ejemplos, problemas, preguntas y glosario. |
| **1.1.0** | **2026-04-27** | **Refactor audit-driven M02**: integración con corpus canónico Glosario Universal (88 conceptos `con-*.md` post-M02). (a) **Fase A1 · 6 must-have**: `con-mlp-geels`, `con-procesos-misionales-pm1-pm2-pm3`, `con-retroalimentaciones-r1-r6`, `con-resultados-emergentes-e1-e3`, `con-salto-cuantico-sub-n1-n4`, `con-anti-patron-departamentalizacion`. (b) **Fase A2 · 9 secondary**: `con-mode-1-2-3`, `con-cuadrante-pasteur-stokes`, `con-seci-ba-nonaka`, `con-core-competencies-prahalad-hamel`, `con-cops-wenger`, `con-tercera-mision-compagnucci`, `con-seis-dimensiones-markard`, `con-triple-helix-etzkowitz`, `con-segunda-revolucion-academica-etzkowitz`. (c) **Fase B · 8 enriquecimientos M00/M01** con cross-refs M02 (acu-004-25, funciones-misionales, omt, caba, cca, taxonomia-sub-n1-n4, cinco-vias-clark, frame-3) + reparación 2 wikilinks bibliográficos rotos (clark1998entrepreneurial → string `bibliografico`; schot2018frame3 → string `bibliografico`). (d) **Fase C · refactor wikilinks**: 15 legacy `_archived/60-glosario/glo-X` → `../00-glosoario-universal/con-X`; transclusiones consolidadas migradas. Cero referencias hardcodeadas; cero wikilinks rotos. M02 plenamente integrado al corpus canónico. |

---

*CC BY-SA 4.0 · Carlos Camilo Madera Sepúlveda · UDFJC · 2026-04-27 · sec-MI12-02 v1.1.0*
