...
> **Licencia**: CC BY-SA 4.0 · **Cita sugerida**: Madera Sepúlveda, C. C. (2026). §06 · BMK-002 El Modelo CCA: Creditización Integral de Funciones Misionales. *Reforma Vinculante UDFJC: Análisis, Buenas Prácticas y Prospectiva Transformativa* (cap-MI12, Sección 6). Universidad Distrital Francisco José de Caldas. https://reforma-ud.vercel.app/canonico/m06/ [DOI pendiente]
...
*Fig-MI12-66 — MODELO [[3-diseño-capitulo-libro/_archived/60-glosario/glo-cca|CCA]] — Competencia-Conocimiento-Atómica (M06 fig #2)*
...
| 1.0.0 | 2026-04-25 | Atomización desde M06-creditos-cca-v2.0.0. 5 figuras extraídas. |
| **1.1.0** | **2026-04-27** | **Refactor audit-driven M06**: integración con corpus canónico (111 conceptos). (a) **Fase A · 3 conceptos**: `con-bmk-002-cca-11-ies`, `con-dublin-descriptors-bologna`, `con-stack-certificacion-open-badges`. (b) **Fase B · enriquecimiento `con-cca`** con BMK-002 + Dublin + Stack. (c) **Fase C · refactor wikilinks**: 6 legacy → canónico. Cero wikilinks rotos. |

---

*CC BY-SA 4.0 · Carlos Camilo Madera Sepúlveda · UDFJC · 2026-04-27 · sec-MI12-06 v1.1.0*
