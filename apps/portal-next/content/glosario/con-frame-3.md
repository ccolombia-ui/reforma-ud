...
skos_notation: "Frame 3 / TIP"

iso_designation_type: term
iso_definition_type: intensional
iso_genus: "Marco conceptual de política de ciencia, tecnología e innovación"
iso_differentia: "Exige direccionalidad transformativa explícita hacia misiones sociotécnicas; supera el modelo lineal de Frame 1 y el sistémico de Frame 2 incorporando dimensión normativa-ética"
iso_subject_field: "Política de innovación / Estudios CTI / Sustainability transitions"
...
> [!important]+ 🌍 Paradigma rector de la política CTI colombiana 2022-2031
> Frame 3 fue adoptado formalmente por el [[con-conpes-4069|CONPES 4069/2021]] como paradigma rector de la Política Nacional CTI. Por cadena normativa multinivel (Const. 1991 Art. 69 → Ley 30/1992 Art. 6 → CONPES → PIIOM → ACU-004-25), Frame 3 es **mandato vinculante** para todas las IES públicas colombianas, incluyendo la UDFJC.

## Definición operativa

Tercer marco conceptual de política de innovación que reemplaza la pregunta dominante de cada generación previa:

| Marco | Pregunta rectora | Mecanismo | Limitación |
|---|---|---|---|
...
## Fuente primaria (cita literal)

> "Exploring options for transformative innovation policy should be a priority." — **Schot & Steinmueller (2018, p. 1567)**.
...
## Genealogía conceptual (NeOn S3)

| Fuente | Aporte |
|---|---|
| **Schot & Steinmueller (2018)** | Formulación canónica de los 3 frames + propuesta de TIP |
| **Sustainability transitions literature** (Geels 2002, Markard et al. 2012) | Marco MLP de transiciones que sustenta direccionalidad |
| **Mazzucato (2018) Mission-Oriented Policy** | Conexión con políticas de misión gubernamental |
| **Adopción colombiana CONPES 4069/2021** | Paradigma rector SNCTI 2022-2031 |

## Lenguaje ubicuo asociado

Frame 3 · TIP (Transformative Innovation Policy) · Direccionalidad · Misiones transformativas · Cambio sociotécnico · Política orientada a misiones.

## Notas de aplicación

- **Cuándo invocarlo**: para justificar por qué un proyecto PM2 debe demostrar contribución a misión PIIOM (no basta con productividad académica Frame 1 ni con redes Frame 2).
- **Cuándo NO basta**: si solo se invoca como retórica sin métricas de transformación verificable, viola el espíritu de Frame 3.
- **Conexión con M01-M12**: M01 §2.1-§4.4 desarrolla la cadena Frame 3 → CONPES 4069 → PIIOM → ACU-004-25; M02 ciclo virtuoso ΩMT operacionaliza la direccionalidad; M07 21 BPAs son palancas concretas Frame 3.
